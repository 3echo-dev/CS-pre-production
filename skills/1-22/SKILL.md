...
name: 1-22
description: >
  Entry point for One Dash 1-22 pre-production. Reads what is already in progress, opens the
...
| Onboard | Ask for the client name, Sham's site list and the four template files, then scaffold with `scaffold-brand.js`, drop the templates under `client/templates/` and the sites in `client/sites.md`. |
