...
const GETTING_STARTED = [
  ...
  'first, tell them:',
  '',
  '  1. /onedash-1-22:1-22                       opens the board and asks whether to start or resume a project',
  '  2. /onedash-1-22:new-project {client}       pulls the Drive folder, reads the brief, runs to Gate A',
  '  3. /onedash-1-22:review {job} approve       or "change ..." or "start over", at any gate, when the board is not to hand',
  '',
